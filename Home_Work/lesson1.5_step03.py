...
#'//div[@class="container"]/form/div[1]/input'
...
# button = browser.find_element_by_css_selector("button.btn")
# button.click()
# Создайте файл lesson5_step3.py (обратите внимание на расширение .py) и вставьте туда шаблон кода. Подберите селекторы и запустите из командной строки, так же, как в уроке 2: 
